...
public class Meal {
    ...
    public float getTotalIron() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getIron();
        }
        return sum;
    }
    ...
    public float getTotalSodium() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getSodium();
        }
        return sum;
    }
    ...
    public float getTotalPotassium() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getPotassium();
        }
        return sum;
    }
    ...
    public float getTotalCalcium() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getCalcium();
        }
        return sum;
    }
    ...
    public float getTotalVitb12() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getVitB12();
        }
        return sum;
    }
    ...
    public float getTotalVitc() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getVitC();
        }
        return sum;
    }
    ...
    public float getTotalVitd() {
        float sum = 0;
        for (MealComponent i : components) {
            sum += i.getMass() * i.getFoodstuff().getVitD();
        }
        return sum;
    }
    ...
    public int getTotalIronRounded() {
        return Math.round(getTotalIron());
    }

    public int getTotalSodiumRounded() {
        return Math.round(getTotalSodium());
    }

    public int getTotalPotassiumRounded() {
        return Math.round(getTotalPotassium());
    }
    ...
    public int getTotalVitb12Rounded() {
        return Math.round(getTotalVitb12());
    }

    public int getTotalVitcRounded() {
        return Math.round(getTotalVitc());
    }

    public int getTotalVitdRounded() {
        return Math.round(getTotalVitd());
    }
